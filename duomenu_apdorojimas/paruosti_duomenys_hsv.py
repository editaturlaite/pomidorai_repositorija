...
from duomenu_apdorojimas.konvertuoti_i_hsv import konvertuoti_viska_i_hsv_taisyklingai
from duomenu_apdorojimas.paveiksleliu_nuskaitymas import nuskaityti_duomenis_is_npy
import pandas as pd
...
issaugojimo_kelias = r"C:\Users\Vartotojas\Desktop\POMIDORAI\pomidoru_duomenys_hsv_taisyklingai" #taisyklingai
konvertuoti_viska_i_hsv_taisyklingai(pradinis_kelias, issaugojimo_kelias)
...
x_train, y_train, klasiu_zodynas = nuskaityti_duomenis_is_npy(train_kelias_HSV)
x_val, y_val, _ = nuskaityti_duomenis_is_npy(val_kelias_HSV)
x_test, y_test, _ = nuskaityti_duomenis_is_npy(test_kelias_HSV)
